...
urlpatterns = [
    path('admin/', admin.site.urls),
     path('', recog_views.home, name='home'),
      ...
      path('dashboard/', recog_views.dashboard, name='dashboard'),
       ...
       path('videofeed/<cam>', recog_views.livefeed, name='videofeed'),
    ...
    path('logout/',auth_views.LogoutView.as_view(template_name='recognition/home.html'),name='logout'),
     ...
     path('mark_your_attendance', recog_views.test_mark_your_attendance ,name='mark-your-attendance'),
      path('mark_your_attendance_out', recog_views.test_mark_your_attendance_out ,name='mark-your-attendance-out'),
